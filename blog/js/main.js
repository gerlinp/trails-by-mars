...
(function(html) {
    ...
    * ------------------------------------------------------ */
    ...
    /* TBM Blog Header Mobile Menu
 * ------------------------------------------------------ */
const tbmMobileMenu = function() {
    const menuToggle = document.querySelector('.tbm-header__menu-toggle');
    const menuLinks = document.querySelector('.tbm-header__menu-links');
    if(menuToggle && menuLinks) {
        menuToggle.addEventListener('click', function(e) {
            e.preventDefault();
            menuLinks.classList.toggle('tbm-header__menu-links--open');
        });
    }
}; // end tbmMobileMenu
